// <copyright file="TerjeCraftSoapWater.c" author="Terje Bruoygard">
...
class TerjeCraftSoapWater extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_Controls_Combine";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TerjeSoap");//you can insert multiple ingredients this way
	...
	{
		if (ingredients[1].GetQuantity() > 0)
		{
			if (ingredients[1].GetLiquidType() & LIQUID_GROUP_WATER)
			{
				return true;
			}
		}
