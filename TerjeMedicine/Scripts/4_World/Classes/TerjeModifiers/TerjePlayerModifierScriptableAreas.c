// <copyright file="TerjePlayerModifierScriptableAreas.c" author="Terje Bruoygard">
...
class TerjePlayerModifierScriptableAreas : TerjePlayerModifierBase
{
	...
	override void OnServerFixedTick(PlayerBase player, float deltaTime)
	{
		...
		{
			additionalRadiation *= GetTerjeSettingFloat(TerjeSettingsCollection.MEDICINE_RADIOACTIVE_AREAS_POWER_MOD);
		}
		...
		float radiationGearTransferMod = GetTerjeSettingFloat(TerjeSettingsCollection.MEDICINE_RADIATION_TRANSFER_GEAR);
