	...
	override void EEKilled(Object killer)
	{
		...
		if (GetTerjeSettingBool(TerjeSettingsCollection.STARTSCREEN_SOULS_ENABLED))
		{
			...
			if (killerEntity)
			{
				...
				{
					int soulsCount = GetTerjeSettingInt(TerjeSettingsCollection.STARTSCREEN_SOULS_KILLZMB_COUNT);
					float soulsChance = GetTerjeSettingFloat(TerjeSettingsCollection.STARTSCREEN_SOULS_KILLZMB_CHANCE);
