...
1. **PROPHYLAXIS AND TREATMENT**
   + [Medicines](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-medicines)
   + [Vaccines](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-vaccines)
   + [Disinfection](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-disinfection)
     
2. **PHYSICAL CONDITION**
   + [Hematomas](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-hematomas)
   + [Gunshot Wounds](https://github.com/TerjeBruoygard/TerjeModsScripting/edit/master/Wiki/en/Medicine/README.md#-----internal-organ-gunshot-and-stab-wounds)
   + [Stab Wounds](https://github.com/TerjeBruoygard/TerjeModsScripting/edit/master/Wiki/en/Medicine/README.md#-----internal-organ-gunshot-and-stab-wounds)
   + [Internal Organ Wound](https://github.com/TerjeBruoygard/TerjeModsScripting/edit/master/Wiki/en/Medicine/README.md#-----internal-organ-gunshot-and-stab-wounds)
   + [Surgical Sutures](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-surgical-sutures)
   + [Concussion](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-concussion)
   + [Hemostasis](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-hemostasis)
   + [Hematopoiesis](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-hematopoiesis-blood-regeneration)

3. **INFECTIONS AND DISEASES**
   + [Cold](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-cold--pneumonia)
   + [Food Poisoning](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-food-poisoning)
   + [Chemical Poisoning](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-chemical-poisoning)
   + [Zombie Virus](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-zombie-virus)
   + [Sepsis](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-sepsis)
   + [Rabies](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-rabies)

4. **SYMPTOMS**
   + [Pain](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-pain)
   + [Overdose](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-overdose)

5. **EMOTIONAL STATES**
   + [Sleep](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-sleep)
   + [Mental Health](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-mental-health)

6. **ZONES**
   + [Psionic Zones](https://github.com/TerjeBruoygard/TerjeModsScripting/edit/master/Wiki/en/Medicine/README.md#-psionic-zone)
...
To safely visit Psionic zones, you must use [antidepressants](https://github.com/TerjeBruoygard/TerjeModsScripting/tree/master/Wiki/en/Medicine#-mental-state) to stabilize your mental state.
