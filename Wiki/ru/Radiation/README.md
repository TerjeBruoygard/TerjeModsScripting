...
Для более тонкой настройки вы можете прописать защиту определенной одежде, в зависимости от силы радиации. При таком распределении не будут учитываться настройки указанные в Способе №1.
