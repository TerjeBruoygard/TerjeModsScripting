...
>Психическое состояние персонажа ухудшается при сильном стрессе: нападения зомби, длительное нахождение в опасных пси-зонах и употребление в пищу человеческого мяса приводят к нервным срывам и галлюцинациям. В таких условиях у персонажа может развиваться чувство паники и дезориентации, что осложняет выживание и взаимодействие с окружающим миром.
Для смягчения симптомов используйте антидепрессанты, которые стабилизируют психику и облегчают негативное влияние стресс-факторов.
...
1. **Радиация накапливается в организме** в виде "рад-буфера" при:
   - Нахождении в радиационной зоне.
   - Контакте с зараженными предметами.  
2. **Рад-буфер** постепенно вызывает [Радиационное отравление](#image-радиационное-отравление), которое развивается по мере накопления радиации.  
3. **Объекты и одежда тоже заражаются**:
...
- Человек **не умирает напрямую от радиации**, но:
  - Сильное облучение вызывает [Радиационное отравление](#image-радиационное-отравление).
...
Без должной защиты и подготовки радиационные зоны становятся **смертельно опасными** для жизни выживших.
