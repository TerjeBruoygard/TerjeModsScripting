...
Для настройки получения опыта при убийстве модовых животных и зомби вам потребуется создать свой мод с файлом config.cpp.
Разберем пример на добавление модовых животных - **BlackWolf**, **Squirrel**, зомби - **Zmb_mutant** и модовой рыбы - **Pike**
