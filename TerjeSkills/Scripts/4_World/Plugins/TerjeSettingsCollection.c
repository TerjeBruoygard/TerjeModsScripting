...
modded class TerjeSettingsCollection
{
	...
	override void OnInit()
	{
		...
		SKILLS_STEALTH_BEARS_FRIEND_CRIT_DISTANCE = RegisterSettingFloat("Skills.StealthBearsFriendCritDistance", "Skills", "Sets the minimum distance value. If the player comes closer than this distance to the bear - the perk BearsFriend stops working.", 10.0, true);
		...
		SKILLS_HUNTING_HEADSHOT_ANIMAL_EXP_GAIN_MODIFIER = RegisterSettingFloat("Skills.HuntingHeadshotAnimalExpGainModifier", "Skills", "Sets the value of the experience modifier that the player will get after killing an animal with headshot in additional to HuntingKillAnimalExpGainModifier. This modifier is multiplied by the parameter terjeOnHeadshotHuntingExp from the animal's config.", 1.0, true);
		SKILLS_HUNTING_BUTCH_ANIMAL_EXP_GAIN_MODIFIER = RegisterSettingFloat("Skills.HuntingButchAnimalExpGainModifier", "Skills", "Sets the value of the experience modifier that the player will get after butchering an animal. This modifier is multiplied by the parameter terjeOnButchHuntingExp from the animal's config.", 1.0, true);
		...
		SKILLS_FISHING_FAILED_CATCH_EXP_GAIN = RegisterSettingInt("Skills.FishingFailedCatchGainExp", "Skills", "Sets the experience value that the player will receive if the catch is failed. This parameter is also affected by 'ExperienceGainModifier'.", 50, true);
